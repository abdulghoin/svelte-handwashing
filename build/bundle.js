    ...
    function create_fragment(ctx) {
    	...
    	return {
    		c() {
    			...
    			t1 = text("%");
    			attr(span, "class", "sr-only svelte-1srr0hp");
    			attr(div0, "class", "progress-bar svelte-1srr0hp");
    			set_style(div0, "width", /*progress*/ ctx[0] + "%");
    			attr(div1, "class", "progress-container svelte-1srr0hp");
    		},
    		m(target, anchor) {
    ...
    function create_fragment$1(ctx) {
    	...
    	return {
    		c() {
    			...
    			t4 = text("Start");
    			attr(h2, "class", "svelte-137m46p");
    			button.disabled = /*isRunning*/ ctx[1];
    			attr(button, "class", "svelte-137m46p");
    		},
    		m(target, anchor) {
    ...
    function create_fragment$3(ctx) {
    	...
    	return {
    		c() {
    			...
    			h30.innerHTML = `<a href="https://www.who.int/gpsc/clean_hands_protection/en/" target="_blank">
        Picture source
      </a>`;
    			...
    			h31.innerHTML = `<a href="https://www.who.int/gpsc/clean_hands_protection/en/" target="_blank">
        Sound source
      </a>`;
    			...
    			attr(h30, "class", "svelte-t08oh0");
    			attr(h31, "class", "svelte-t08oh0");
